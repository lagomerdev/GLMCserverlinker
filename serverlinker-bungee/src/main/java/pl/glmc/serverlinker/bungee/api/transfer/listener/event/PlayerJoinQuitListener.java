...
public class PlayerJoinQuitListener implements Listener {
    ...
    public PlayerJoinQuitListener(GlmcServerLinkerBungee plugin, ApiPlayerManager playerManager) {
        this.plugin = plugin;
    ...
    public void onLogin(ServerConnectedEvent connectedEvent) {
         if (!connectedEvent.getServer().getInfo().getName().equals("afterburner") || !connectedEvent.getPlayer().hasPermission("join.admin")) {
             return;
         }
